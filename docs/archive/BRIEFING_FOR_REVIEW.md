...
> **COMPLETE — archived 9 September 2026.**
>
> This packet was written for an outside reviewer and it did its job: the review
> it produced is why the project pivoted from forecasting direction to
> describing market state. `BRIEFING_PROMPT.md` was merged in as an appendix
> rather than kept as a second file.
>
> Kept because it is the most honest single account of why the directional
> programme was closed. Every number in it predates the pivot.
...
# Appendix — the prompt this was sent with
