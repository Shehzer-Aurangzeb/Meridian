...
export class AnalysisController {
   ...
   * GET /analysis/leverage-constraints?experienceLevel=intermediate&timeframe=4h
   */
  @Get('leverage-constraints')
  @SkipThrottle()
  ...
  /**
   * MASTER ENDPOINT - Complete Analysis with Everything
   * POST /analysis/complete
   *
   * This is the main endpoint frontend should use.
   * Returns everything: multi-timeframe, checklist, S/R, AI, risk management
   */
  @Post('complete')
  @Throttle({ default: { limit: 5, ttl: 60000 } }) // 5 requests per minute (heavy endpoint)
   ...
   * POST /analysis/quick
   *
   * Faster analysis that skips risk management calculations
   */
  @Post('quick')
